    ...
    <div class="lg:grid lg:grid-cols-12 lg:gap-x-16" tag-id="tag-iVeug89t">
      <div
        ...
        <div
          ...
          <div tag-id="tag-8abWlVdB">T</div>
          <div tag-id="tag-cj9ct3LK">F</div>
        ...
        <button
          type="button"
          class="hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 bg-indigo-600 font-semibold mt-8 px-3 py-2 rounded-md shadow text-sm text-white w-full"
          tag-id="tag-rs1RUPnQ">
          Add event
        </button>
      </div>
