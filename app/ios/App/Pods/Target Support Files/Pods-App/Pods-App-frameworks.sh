...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CapacitorCommunityAppIcon/CapacitorCommunityAppIcon.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CapacitorCommunityBackgroundGeolocation/CapacitorCommunityBackgroundGeolocation.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CapacitorCommunityBarcodeScanner/CapacitorCommunityBarcodeScanner.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CapacitorCommunitySpeechRecognition/CapacitorCommunitySpeechRecognition.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CapacitorScreenReader/CapacitorScreenReader.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CapacitorTextZoom/CapacitorTextZoom.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CapacitorToast/CapacitorToast.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CapgoCapacitorUpdater/CapgoCapacitorUpdater.framework"
